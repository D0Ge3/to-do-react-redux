...
// Этот файл я бы подробил, чтобы не было дофига экспортов разных компонентов из одного файла

// И для папки common сделать index.js, в котором будут все компоненты (сделал)
